...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top bg-blue" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Erwin Store</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> Last access : 23 July 2020 &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=pelanggan"><i class="fa fa-group"></i> Pelanggan</a></li>
